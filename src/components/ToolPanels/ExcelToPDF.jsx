...
import { excelToPDF } from '../../services/pdf/excelToPdf';
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> This conversion preserves data and basic formatting. 
          Complex formulas, charts, and advanced features may not be fully preserved.
        </p>
      </div>
