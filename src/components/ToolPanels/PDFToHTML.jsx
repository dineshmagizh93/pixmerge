...
import { pdfToHTML } from '../../services/pdf/pdfToHtml';
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Note: PDF pages will be converted to images embedded in HTML.
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-700 mb-4">
              PDF has been converted to HTML successfully.
            </p>

            <div className="border border-gray-200 rounded-lg p-4 max-h-64 overflow-y-auto bg-gray-50 mb-4">
