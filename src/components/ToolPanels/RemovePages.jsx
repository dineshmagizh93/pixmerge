...
import { removePages } from '../../services/pdf/organize';
...
const RemovePages = () => {
  ...
  const handleRemove = async () => {
    ...
    try {
      ...
      const pdfBytes = await removePages(file, pagesToRemove);
  ...
  const handleDownload = () => {
    if (result) {
      const filename = file.name.replace('.pdf', '_removed.pdf');
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Remove pages from PDF</h1>
      ...
      {file && !result && totalPages > 0 && (
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="flex space-x-4">
            ...
            >
              {processing ? 'Removing...' : `Remove ${selectedPages.size} page(s)`}
            </button>
            <button
              onClick={handleReset}
      ...
      {result && (
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Pages Removed!</h2>
            <p className="text-gray-700">
              Selected pages have been removed from the PDF.
            </p>
          </div>
