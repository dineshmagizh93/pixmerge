...
const GrayscalePDF = () => {
  ...
  const handleDownload = () => {
    if (result) {
      const filename = file.name.replace('.pdf', '_grayscale.pdf');
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Convert PDF to Grayscale</h1>
        <p className="text-lg text-gray-600">
          Convert your PDF to grayscale (black and white).
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Note: This process may take longer for large PDFs as each page is rendered and converted.
            </p>
          </div>
      ...
      {result && (
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-700">
              PDF has been converted to grayscale successfully.
            </p>
          </div>
